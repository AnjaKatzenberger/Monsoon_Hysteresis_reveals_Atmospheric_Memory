...
axes.plot(sw_w[11], pr_w[11], marker='.', color="blue")
...
axes.plot(sw_n[11], pr_n[11], marker='.', color="blue")
...
axes.plot(sw_s[11], pr_s[11], marker='.', color="blue")
...
# Show the plot
plt.title('World Map with Specified Latitude and Longitude Boundaries')
plt.show()
# %%
